...
<template>
  <main id="home" class="container grid grid-cols-12 gap-5 relative overflow-hidden">
    <div class="col-span-6 md:col-span-12 row">
        <CardBasic class="col-6">
    ...
    <div class="col-12 row">
        <div class="col-6 row">
            <CardBasic v-for="portfolio in portfolios" :key="portfolio" class="col-12 flex flex-row gap-5 hover:cursor-pointer"
                @click="showDetail(portfolio)"
                :class="{'bg-zinc-800': portfolioActive && portfolio.id == portfolioActive.id}"
            >
                <div class="w-1/2 aspect-video rounded-lg overflow-hidden bg-cover bg-top"
        ...
        <div class="col-6 gap-5" v-if="portfolioActive">
            <div class="sticky top-0 flex flex-col gap-5" id="sticky-card">
